    ...
    <div class="content-body p-3">
        ...
        <div class="container mt-3 bg-white p-4">
            ...
            <form method="POST" enctype="multipart/form-data" class="row">
                <div class="col-lg-4">
                    <label class="form-label" for="val-username">Category <span class="text-success">*</span>
                    </label>
                ...
                <div class="col-lg-4">
                    <label class="form-label" for="val-username">Category Image <span class="text-success">*</span>
                    </label>
                    <input type="file" class="form-control" id="val-username" name="image" accept="image/*"  required>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <button class="btn btn-success text-white btn-lg mt-2 w-100">Add Category</button>
                ...
                <table class="table table-striped table-bordered zero-configuration">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><img src="./images/categories/<?php echo $row['image'] ?>" alt="" height="50px"></td>
                            <td>
                                <div class="dropdown">
